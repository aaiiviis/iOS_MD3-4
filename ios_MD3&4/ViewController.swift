...
class ViewController: UIViewController, MKMapViewDelegate,secondControllerDelagate {
    ...
    override func viewDidLoad() {
        ...
        let point1 = Place(title: "RTU", discipline: "Nice University", coordinate: CLLocationCoordinate2D(latitude:56.947260, longitude: 24.105201))
       
        let point2 = Place(title: "LLU", discipline: "Farmer university", coordinate: CLLocationCoordinate2D(latitude:56.655519, longitude: 23.733192))
       
        let point3 = Place(title: "Via", discipline: "Best university", coordinate: CLLocationCoordinate2D(latitude:57.535176, longitude: 25.424048))
